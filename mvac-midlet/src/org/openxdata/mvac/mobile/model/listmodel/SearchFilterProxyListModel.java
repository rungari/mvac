...
package org.openxdata.mvac.mobile.model.listmodel;
 ...
 * @author mutahi
 */
public class SearchFilterProxyListModel implements ListModel , DataChangedListener{

   private ListModel underlying;
   private Vector filter;
   private Vector listeners = new Vector();
   
   public SearchFilterProxyListModel(ListModel underlying) {
   ...
   public void filter(String str) {
       ...
       for(int iter = 0 ; iter < underlying.getSize() ; iter++) {
           String element = ((SearchObject)underlying.getItemAt(iter)).getChild_name();
