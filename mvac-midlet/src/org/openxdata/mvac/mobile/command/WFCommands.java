...
public class WFCommands {
    ...
    public static Command cmdRetireWorkItem = new Command("Cancel Workitem", Command.SCREEN, 1);
    public static Command cmdUpdateForms = new Command("Reset Forms", Command.SCREEN, 1);
    public static Command cmdSubmitSelected = new Command("Submit Selected Workitem", Command.SCREEN, 1);
}
