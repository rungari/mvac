...
//	}
    ...
    protected void connectHttp() {
        try {
            ...
            System.out.println(" @Transport Layer . Something thrown :" + t);
            this.eventListener.errorOccured(" Error thrown " + t, null);
        } finally {
            try {
                if (con != null) {
                    con.close();
     ...
     */
    public void run() {
        System.out.println(" before handle http request Isdownload=>" + isDownload);
        handleRequest();
    }
